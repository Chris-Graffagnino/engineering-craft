...
- **Scope & coverage (lead with this).** What was deep-reviewed, what got the cheap pass only, what was excluded and why — plus the P0 ranking and cutoff from step 2, and which craft dimensions the codebase exercised vs. never surfaced.
